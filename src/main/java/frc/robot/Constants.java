...
public final class Constants {
  ...
  public static class MotorConstants {
    ...
    public static final double kS_talonFx = 0.00; // Add 0.1 V output to overcome static friction
    ...
    public static final double maxRPS_talonFx = 95.0; // 5,700 RPM based on 6,000 RPM max for X60, could be based on 7,350 RPM max for X44
  }
}
